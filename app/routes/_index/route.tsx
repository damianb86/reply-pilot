      ...
      <section className={styles.hero}>
        <div className={styles.copy}>
          ...
          <p className={styles.lede}>
            AI drafts for connected review platforms, trained on the merchant's brand
            voice and approved from a Shopify-native queue.
          </p>
          <p className={styles.lede}>
            Open ReplyPulse from Shopify Admin or from the Shopify App Store to
            continue securely.
          </p>
        </div>

        <div className={styles.panel} aria-label="ReplyPulse capabilities">
          <div>
