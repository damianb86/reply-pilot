    ...
    try {
      ...
      await sendContactEmail({
        ...
        message: [
          `Shop: ${session.shop}`,
          "",
          "The merchant requested deletion of all Reply Pulse AI: Review Replies app data.",
      ...
      return {
        ok: true,
        intent,
        message: "All Reply Pulse AI: Review Replies app data has been permanently deleted.",
      };
    } catch (error) {
