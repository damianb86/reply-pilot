      ...
      <InlineStack align="space-between" blockAlign="center" gap="300">
        <BlockStack gap="100">
          ...
          <Text as="p" variant="bodyLg" tone="subdued">
            Configure app defaults and tune the Brand Voice Reply Pulse AI: Review Replies uses for AI replies.
          </Text>
        </BlockStack>
        {!isBrandVoiceSection ? (
        ...
        <BlockStack gap="400">
          ...
          {activeSection === 'queue' ? (
            <SectionCard
              ...
              description="Control how Reply Pulse AI: Review Replies marks drafts for review and how Judge.me sends approved replies."
          ...
          {activeSection === 'privacy' ? (
            <SectionCard
              title="Data & privacy"
              description="Control how long sent and skipped review history remains available in Reply Pulse AI: Review Replies."
              action={(
                <Button
