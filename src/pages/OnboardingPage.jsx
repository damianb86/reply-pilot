...
function WizardHeader({step}) {
  const copy = {
    connect: {
      ...
      description: 'Start by connecting a supported review source so ReplyPulse can verify access before drafting anything.',
    },
    builder: {
    ...
    preview: {
      ...
      description: 'Pick a product, adjust the rating and review text, then generate a preview to see how ReplyPulse will answer.',
    },
    finish: {
      title: 'Finalize setup',
      description: 'Save this setup once. After this, ReplyPulse will open normally and use these settings for reviews and previews.',
    },
  }[step.id];
          ...
          <Box padding="0">
            <div className="rp-onboarding-finish-card">
              ...
              <BlockStack gap="250" align="center">
                <Text as="h2" variant="heading2xl" alignment="center">ReplyPulse is ready</Text>
